...
public interface IBookService
{
    ...
    Task<(CustomResult<IEnumerable<Book>>, PaginationMetadata)> GetAsync(string userEmail, int pageNumber, int pageSize, string? searchTerm = "", CancellationToken cancellationToken = default);
