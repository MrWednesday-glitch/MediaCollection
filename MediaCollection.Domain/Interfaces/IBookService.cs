...
public interface IBookService
{
    ...
    Task<(CustomResult<IEnumerable<Book>>, PaginationMetadata)> GetAsync(int pageNumber, int pageSize, string? searchTerm = "", CancellationToken cancellationToken = default);
